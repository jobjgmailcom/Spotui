...
La revisión [`43974f3`](https://github.com/jobjgmailcom/Spotui/commit/43974f3b3cd0044e8dfac1683b1f067ac0c16709) aprobó `:app:testDebugUnitTest` y `:app:assembleDebug` localmente. La CI [33025622816](https://github.com/jobjgmailcom/Spotui/actions/runs/33025622816) también aprobó pruebas, ensamblado y auditoría FOSS con Java 17, `--no-daemon` y un trabajador. La APK remota conserva `com.music.spotui` 1.4/14 y firma v2; su SHA-256 es `43e01582cd5ee7a0ad6426bd77800f9d2cfa52f862a3406cd15ac2d27a80a880`. La revisión independiente del DEX no detectó Firebase, Google Play Services, Media3 Cast ni las cadenas del flujo Spotify WebView retirado.
